var L=Object.defineProperty;var P=(e,t,r)=>t in e?L(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var p=(e,t,r)=>P(e,typeof t!="symbol"?t+"":t,r);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const h of n.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&i(h)}).observe(document,{childList:!0,subtree:!0});function r(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=r(s);fetch(s.href,n)}})();const S=()=>`
...
`,v={checkProfileAccess(){return l.isLoggedIn()?null:{redirect:o+"login"}},checkLoginAccess(){return l.isLoggedIn()?{redirect:o}:null}},j={[o]:I,[o+"profile"]:()=>{const e=v.checkProfileAccess();return e||U()},[o+"login"]:()=>{const e=v.checkLoginAccess();return e||N()}};let g=null;const B=(e={mode:"history"})=>(g=b.getInstance(j,{...e,base:o}),g),m=()=>{if(!g)throw new Error("Router has not been initialized");return g};export{B as i};
