var x=Object.defineProperty;var v=(t,e,s)=>e in t?x(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var h=(t,e,s)=>v(t,typeof e!="symbol"?e+"":e,s);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();const w=()=>`
  ...
  `,m=()=>{const t=localStorage.getItem("user");return t?JSON.parse(t):null},y=t=>{localStorage.setItem("user",JSON.stringify(t))},$=()=>{localStorage.removeItem("user")},d=()=>m()!==null,P=t=>{const e=m();localStorage.setItem("user",JSON.stringify({...e,...t}))},a=class a{static getInstance(e,s){return a.instance||(a.instance=new a(e,s)),a.instance}constructor(e,s={mode:"history",base:"/"}){if(a.instance)return a.instance;this.routes=e,this.mode=s.mode,this.base=s.base;const i=()=>{this.render()};this.mode==="hash"?window.addEventListener("hashchange",i):window.addEventListener("popstate",i),a.instance=this,document.addEventListener("click",r=>{r.target.matches("[data-link]")&&(r.preventDefault(),this.navigate(r.target.getAttribute("href")))}),document.addEventListener("submit",r=>{if(r.target.id==="login-form"){r.preventDefault();const n=document.getElementById("username").value;y({username:n,email:"",bio:""}),this.navigate("/profile")}if(r.target.id==="profile-form"){r.preventDefault();const n=document.getElementById("username").value,l=document.getElementById("email").value,b=document.getElementById("bio").value;P({username:n,email:l,bio:b})}}),document.addEventListener("click",r=>{r.target.matches('[data-action="logout"]')&&(r.preventDefault(),$(),this.navigate("/login"))})}getCurrentPath(){if(this.mode==="hash")return console.log("hash",window.location.hash),window.location.hash.slice(1)||"/";const s=new URLSearchParams(window.location.search).get("p");return s!=null&&s.startsWith("/")?(console.log("redirectPath",s),s):(console.log("pathname",window.location.pathname),window.location.pathname)}navigate(e){const s=this.base+e.replace(/^\//,"");this.mode==="hash"?window.location.hash=e:window.history.pushState({},"",s),this.render()}render(){this.currentPath=this.getCurrentPath();const e=this.routes[this.currentPath]?this.routes[this.currentPath]():w();if(e&&typeof e=="object"&&e.redirect){this.navigate(e.redirect);return}const s=document.getElementById("root");s&&(s.innerHTML=e)}};h(a,"instance",null);let u=a;const o="/front_5th_chapter1-1/",f=()=>{const e=N().currentPath;return`
...
`,j={[o]:L,[o+"profile"]:()=>d()?A():{redirect:o+"login"},[o+"login"]:()=>d()?{redirect:o}:O()};let c=null;const D=(t={mode:"history"})=>(c=u.getInstance(j,{...t,base:o}),c),N=()=>{if(!c)throw new Error("Router has not been initialized");return c};export{D as i};
